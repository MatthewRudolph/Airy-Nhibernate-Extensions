...
using Dematt.Airy.Nhibernate.Extensions.Linq;
    ...
    public class SessionFactoryProvider
    {
        ...
        private void CreateNHibernateSessionFactory()
        {
            if (DefaultSessionFactory == null)
            {
                ...
                var domainType = typeof(TestEntityParent);
                ...
                domainMapper.Class<TestEntityParent>(c =>
                {
                    c.Id(p => p.Id, m =>
                    {
                ...
                domainMapper.Class<TestEntityChild>(c =>
                {
                    c.Id(p => p.Id, m =>
                    {
                        m.Generator(Generators.GuidComb);
                    ...
                    c.Property(p => p.NumberOfApples, m =>
                    {
                        m.NotNullable(true);
                    });
                });
